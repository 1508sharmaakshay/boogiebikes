...
(function( jQuery ){
  var $module = jQuery('#m-1661861307559').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1661861307556').children('.module');   
...
(function(jQuery) {
    var $module = jQuery('#m-1661861307559-2').children('.module');
...
(function(jQuery) {
  var $module = jQuery('#m-1661861307532').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1661861307560').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1661861307527').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1661861307559-3').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1661861307559-0').children('.module');
  ...
  $module.gfV3ProductImage({
    ...
    'magnify': magnify
        ...
        jQuery(function() {
  var $module = jQuery('#m-1661861307607').children('.module');
...
(function(jQuery) {
  var $module = jQuery('#m-1661861307486').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
...
(function(jQuery) {
  ...
  $module.gfV3ProductSwatches({
    ...
    window.__gfFlowActions = []; window.__gfFlowActions.push([{"source":{"id":"#r-1661861307515"},"events":[{"key":"scrolling-to-percentage","data":{"condition":"gte","percentage":23,"runtime":"infinite"}}],"targets":[{"id":"#r-1661861307515","actions":[{"key":"show","type":2,"data":{"delay":0,"duration":50}}]}]},{"source":{"id":"#r-1661861307515"},"events":[{"key":"scrolling-to-percentage","data":{"condition":"lt","percentage":21,"runtime":"infinite"}}],"targets":[{"id":"#r-1661861307515","actions":[{"key":"hide","type":2,"data":{"delay":0,"duration":50}}]}]}]); window.__gfV1FlowActions.init();
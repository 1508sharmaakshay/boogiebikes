...
(function( jQuery ){
  var $module = jQuery('#m-1661861808643').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1661861808597').children('.module');   
...
(function(jQuery) {
    var $module = jQuery('#m-1661861808643-2').children('.module');
...
(function(jQuery) {
  var $module = jQuery('#m-1661861808600').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1661861808590').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1661861808615').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1661861808643-3').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1661861808643-0').children('.module');
  ...
  $module.gfV3ProductImage({
    ...
    'magnify': magnify
        ...
        jQuery(function() {
  var $module = jQuery('#m-1661861808602').children('.module');
...
(function(jQuery) {
  var $module = jQuery('#m-1661861808584').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
...
(function(jQuery) {
  ...
  $module.gfV3ProductSwatches({
    ...
    window.__gfFlowActions = []; window.__gfFlowActions.push([{"source":{"id":"#r-1660820381618"},"events":[{"key":"scrolling-to-percentage","data":{"condition":"gte","percentage":23,"runtime":"infinite"}}],"targets":[{"id":"#r-1660820381618","actions":[{"key":"show","type":2,"data":{"delay":0,"duration":50}}]}]},{"source":{"id":"#r-1660820381618"},"events":[{"key":"scrolling-to-percentage","data":{"condition":"lt","percentage":21,"runtime":"infinite"}}],"targets":[{"id":"#r-1660820381618","actions":[{"key":"hide","type":2,"data":{"delay":0,"duration":50}}]}]}]);window.__gfFlowActions.push([{"source":{"id":"#r-1661861808591"},"events":[{"key":"scrolling-to-percentage","data":{"condition":"gte","percentage":23,"runtime":"infinite"}}],"targets":[{"id":"#r-1661861808591","actions":[{"key":"show","type":2,"data":{"delay":0,"duration":50}}]}]},{"source":{"id":"#r-1661861808591"},"events":[{"key":"scrolling-to-percentage","data":{"condition":"lt","percentage":21,"runtime":"infinite"}}],"targets":[{"id":"#r-1661861808591","actions":[{"key":"hide","type":2,"data":{"delay":0,"duration":50}}]}]}]); window.__gfV1FlowActions.init();
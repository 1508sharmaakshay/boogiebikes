...
(function( jQuery ){
  var $module = jQuery('#m-1661863350070').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1661863350113').children('.module');   
...
(function(jQuery) {
    var $module = jQuery('#m-1661863350070-2').children('.module');
...
(function(jQuery) {
  var $module = jQuery('#m-1661863350139').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1661863350068').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1661863350038').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1661863350070-3').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1661863350070-0').children('.module');
  ...
  $module.gfV3ProductImage({
    ...
    'magnify': magnify
        ...
        jQuery(function() {
  var $module = jQuery('#m-1661863350082').children('.module');
...
(function(jQuery) {
  var $module = jQuery('#m-1661863350098').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
...
(function(jQuery) {
  ...
  $module.gfV3ProductSwatches({
    ...
    window.__gfFlowActions = []; window.__gfFlowActions.push([{"source":{"id":"#r-1661863350175"},"events":[{"key":"scrolling-to-percentage","data":{"condition":"gte","percentage":23,"runtime":"infinite"}}],"targets":[{"id":"#r-1661863350175","actions":[{"key":"show","type":2,"data":{"delay":0,"duration":50}}]}]},{"source":{"id":"#r-1661863350175"},"events":[{"key":"scrolling-to-percentage","data":{"condition":"lt","percentage":21,"runtime":"infinite"}}],"targets":[{"id":"#r-1661863350175","actions":[{"key":"hide","type":2,"data":{"delay":0,"duration":50}}]}]}]); window.__gfV1FlowActions.init();
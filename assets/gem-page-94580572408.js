...
(function( jQuery ){
  // var $module = jQuery('#m-1646678198923').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1643076674908').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1642770535628').children('.module');   
...
(function( jQuery ){
  var $module = jQuery('#m-1643080390198').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1643076674908-3').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1643076674908-0').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1643076800191').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1643076800191";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1643076800191") {
      window.getTab1643076800191 = function() {
...
(function(jQuery) {
    var $module = jQuery('#m-1643076674908-2').children('.module');
...
(function(jQuery) {
  var $module = jQuery('#m-1643076674795').children('.module');
...
(function(jQuery) {
  var $module = jQuery('#m-1643076674827').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
...
jQuery(function() {
  try {
    var $module = jQuery('#m-1643164204138').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
    ...
    if ($module.parent().parent().closest('.module-wrap[data-label="Carousel"]').length > 0) {	
        ...
        jQuery(function() {
  try {
    var $module = jQuery('#m-1643079287312').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
...
(function( jQuery ){
  var $module = jQuery('#m-1643258472991').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1643163368937').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    
(function( jQuery ){
  var $module = jQuery('#m-1643166265692').children('.module');
  if(jQuery().gfYoutube) {
    $module.gfYoutube();
  }
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1643246481538').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
...
(function( jQuery ){
  var $module = jQuery('#m-1643247446495').children('.module');
  var activeTab = parseInt($module.attr('data-activeTab')) - 1;
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  ...
  if(mode == 'dev') {
    var moduleId = "1643247446495";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1643247446495") {
      window.getTab1643247446495 = function() {
        return $module.data('gfv3restabs');
      }
    }
  }
        ...
        jQuery(function() {
  try {
    var $module = jQuery('#m-1643249040438').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1643250040429').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
...
(function(jQuery) {
  ...
  $module.gfV3ProductSwatches({
    ...
    window.__gfFlowActions = []; window.__gfFlowActions.push([{"source":{"id":"#e-1643165220509","target":".elm"},"events":[{"key":"click"}],"targets":[{"id":"#m-1652195761299","actions":[{"key":"showPopup","type":3,"data":{"delay":100}}],"rename":"Popup: #m-1652195761299"}]}]);window.__gfFlowActions.push([{"source":{"id":"#e-1643164832049","target":".gf_image"},"events":[{"key":"click"}],"targets":[{"id":"#m-1652195761299","actions":[{"key":"showPopup","type":3,"data":{"delay":100}}],"rename":"Popup: #m-1652195761299"}]}]);window.__gfFlowActions.push([{"source":{"id":"#r-1643256068200"},"events":[{"key":"scrolling-to-percentage","data":{"condition":"gte","percentage":23,"runtime":"infinite"}}],"targets":[{"id":"#r-1643256068200","actions":[{"key":"show","type":2,"data":{"delay":0,"duration":50}}]}]},{"source":{"id":"#r-1643256068200"},"events":[{"key":"scrolling-to-percentage","data":{"condition":"lt","percentage":21,"runtime":"infinite"}}],"targets":[{"id":"#r-1643256068200","actions":[{"key":"hide","type":2,"data":{"delay":0,"duration":50}}]}]}]); window.__gfV1FlowActions.init();